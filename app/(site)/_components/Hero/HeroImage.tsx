    ...
    return (
        <div className='relative h-full w-full place-self-auto col-span-auto'>
            <div className='relative w-screen lg:h-[33rem] lg:w-[33rem] 2xl:h-[47rem] 2xl:w-[47rem] flex justify-center pb-12'>
                <div className='absolute -top-[4.3rem] left-[5.5rem] -z-[10] w-[25rem] rounded-md'>
                    <Image src={'/assets/hero/pic0.jpg'} height={1000} width={1000} alt="hero Image" className='rounded-md object-cover ' />
                </div>
                <div className='absolute bottom-[1rem] -left-[2rem] h-[5rem] w-[17rem] p-2 b heroOfferCard flex items-center justify-between'>
