...
const CoinOne = () => {
    ...
    return (
        ...
        >
            <motion.div
                layoutId='coin-one'
                className='hover:cursor-pointer h-[4rem] w-[4rem] 2xl:h-[7rem] 2xl:w-[7rem] rounded-full bg-primary heroOfferCard dark:shadow-sm flex items-center justify-center'
                transition={{
                    duration: 0.8,
